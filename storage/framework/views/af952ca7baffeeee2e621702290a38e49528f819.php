	    ...
	    <div class="carousel-inner">
	    	...
	    	<?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="carousel-item">
					<img src="<?php echo e($slider->url_hinhanh); ?>" width="100%" height="400px">
					<div class="carousel-caption">
						<h3><?php echo e($slider->ten); ?></h3>
						<p><?php echo e($slider->motangan); ?></p>
					</div>   
				</div>
			...
			<section class="px-md-1 mx-md-1 light-grey-text text-center text-lg-left">
			  ...
			  <div class="row">
				...
				<div class="col-lg-6 mb-4 mb-lg-0">
				  ...
				  <a class="btn btn-primary" href="<?php echo e(route('dangkiphong')); ?>" >Xem phòng<i class="fa fa-angle-right ml-2"></i></a>
				</div>
				<!--Grid column-->
			  </div>
			  <!--Grid row-->
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/xampp/htdocs/laravel_quanliktx/resources/views/pages/trangchu.blade.php ENDPATH**/ ?>