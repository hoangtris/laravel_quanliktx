...
<?php $__env->startSection('content'); ?>
	...
	<div class="row container-fluid my-5">
		...
		<div class="col-6">
			...
			<form action="<?php echo e(route('dangki')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
