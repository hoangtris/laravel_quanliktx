  ...
  <nav class="navbar navbar-expand-sm navbar-dark" style="background: #2A4B7C ;">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" style="font-size:25px" href="{{ route('trangchu') }}">KÍ TÚC XÁ CAPTAIN HOÀNG TRÍ</a>
      </div>

      <ul class="nav navbar-nav navbar-right">
          <li class="active nav-item"><a href="{{ route('trangchu') }}" class="nav-link">Trang chủ</a></li>
          ...
          <li class="dropdown nav-item">
            ...
            <ul class="dropdown-menu">
                <li><a href="{{ route('dangki') }}" class="dropdown-item">Đăng kí</a></li>
                <li><a href="{{ route('dangnhap') }}" class="dropdown-item">Đăng nhập</a></li>
            </ul>
          </li>        
          <li class="nav-item"><a href="{{ route('tintuc') }}" class="nav-link">Tin tức - Nội quy</a></li>
          <li class="nav-item" style="margin-right:10px;"><a href="{{ route('lienhe') }}" class="nav-link">Liên hệ</a></li>
          <a href="{{ route('dangkiphong') }}" class="btn btn-success">ĐĂNG KÍ PHÒNG</a>
      </ul>
   </div>
  </nav> {{-- navbar --}}
